Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
This project is derived from V2 of HVMobile Library - https://github.com/microsoft-hsg/HVMobile_VNext. In addition to supporting CHBase, this SDK supports the latest version of HealthVault, including its Methods and Datatypes and is actively maintained.</br>
This is a fork of CHBase iOS SDK that adds support for launching the BankID application from within the an application using this SDK, this is an adaptation for the Swedish market.
  ...
  s.platform     = :ios, "4.0"
  s.source       = { :git => "https://github.com/mtlhd/chbase-ios-sdk.git", :tag => 'v0.0.3' }
